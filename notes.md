...
Nowadays, the life of a developer is comprised of prototyping session, production code session, reviews and discussion about it, and overall maintenance of all these artefacts in an intelligible and coherent form. There are for sure teams in which big projects are split down in smaller chunks, but still, these tasks are accomplished by each component of that same team.

Hence, how did the internet replicate and transform the aspect of the maintenance work to such levels of representation, see the `readme.md` file? What are the political potentialities of such a low-profile artefact?