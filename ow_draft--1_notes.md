...
Then there is the history of the commits for each project and the logic behind it. It can be at first connected to the theme of transparency, an obsessive and modernist idea of order, building history and retrieving information. This for sure helps in the making of the project: something is not working anymore, check out the history tab on github and spot what you changed—on click and go back to that position. Good to go again.
...
I love it, to be honest. The idea of tracking your process down to each particular choice and change is quite phenomenal. It is much more if you do your work using text, since you can track down to the single character. But what about this massive accumulation of commits history from all over the world into github.com? I cannot yet define it really well, but the fact of contributing with your own shit, self-voluntarily and often time quite excitingly, to one gigantic buck of information it’s sometimes discomforting. It plays very well with the need of order, easily retrievability and sharing of data, often times looked after by many people. Keeping the situation under control, starting from your own reality. You know you can efficiently (but still with crazy projects) contribute your part to the community you (want to) belong to. 

But if on one level all this it’s already instilling an habit of self-quantification and easily explanation of everything someone is doing, in a sort of just-in-case attitude (cfr. *subjectivation*—e.g. something is wrong, you small element have to explain why and bearing the consequences, avoiding completely the factor of the context and of the larger player, e.g. the working environment and the firm), thus accepting to be part of one big family, so to say one big state—this is happening in general on the mainstream internet landscape, see Facebook, Google, Amazon, Apple, etc.—, only reinforces an idea of perfectly disciplined worker. Such individual is extremely transparent—first of all to himself, then to the big mother who gives him access to the service; self-regulating and efficient; finally being in the reality of the world through his work—how many commits have been pushed to the server and how funny and concise are his readme.md files? How many times will his projects be forked?
